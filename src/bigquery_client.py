...
import pandas as pd
import pyarrow as pa   # Required for BigQuery PyArrow integration
...
class BigQueryClient:
    ...
    def execute_query(self, query: str, job_config: Optional[bigquery.QueryJobConfig] = None) -> bigquery.table.RowIterator:
        """
        ...
        try:
            ...
            logger.info(f"Query executed successfully. Rows processed: {query_job.total_bytes_processed}")
            return results
