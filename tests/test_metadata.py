...
class TestMetadataManager:
    ...
    def test_is_full_year_loaded_true_full_refresh(self, metadata_manager, mock_bq_client):
    ...
    def test_is_full_year_loaded_true_incremental(self, metadata_manager, mock_bq_client):
