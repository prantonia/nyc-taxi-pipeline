...
class RetryHandler:
    ...
    def __init__(self, max_retries: int = MAX_RETRIES, base_delay: int = RETRY_DELAY):
        ...
        logger.info(f"RetryHandler initialized with max_retries={max_retries}, base_delay={base_delay}s")
...
class CircuitBreaker:
    ...
    def __init__(self, failure_threshold: int = 5, timeout: int = 60):
        ...
        logger.info(f"CircuitBreaker initialized with threshold={failure_threshold}, timeout={timeout}s")
...
if __name__ == "__main__":
    ...
    attempt_count = 0
    result = handler.retry_operation(eventually_successful_operation, "Test Operation 2")
